...
final class StreamQuerySerializerTest extends TestCase
{
    ...
    {
        yield ['query' => StreamQuery::create(Criteria::create(EventTypesAndTagsCriterion::create(tags: ['foo:bar']))), 'expectedResult' => '{"version":"1.0","criteria":[{"type":"EventTypesAndTags","hash":"a2d4473e4dd478bf4bc84b6dc39eeed4","properties":{"tags":["foo:bar"],"onlyLastEvent":false}}]}'];
